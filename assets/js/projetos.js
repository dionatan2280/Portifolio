  ...
  section.innerHTML = `<header>
    ...
    <div class="content">
      <div class="cards">
        <div class="card">
          <p>
           Tenho experiência no desenvolvimento de projetos na área eletrônica, tendo participado da criação de soluções na Engenharia Clínica
          </p>
          <svg
        ...
        <div class="card">
          <p>
           Ao longo da minha trajetória, projetei ferramentas de sistemas e dispositivos eletrônicos voltados para a manutenção de equipamentos médicos.
          </p>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
